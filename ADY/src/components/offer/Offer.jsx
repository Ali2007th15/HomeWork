...
const Offer = () => {
    ...
    const [copied, setCopied] = useState(false)
        ...
        const handleCopy = () => {
        navigator.clipboard.writeText("LIIFG")
        .then(() => {
         setCopied(true);
         setTimeout(() => {
            setCopied(true)
        ...
        .catch((err) => {
         ...
         const handleCopy2 = () => {
            navigator.clipboard.writeText("DIMYL")
            .then(() => {
             setCopied(true);
             setTimeout(() => {
                setCopied(true)
                 ...
                 <div className="flex flex-1 flex-col space-y-5">
                    ...
                    <div className="flex items-center gap-x-5">
                        <div className="w-fit border border-dashed px-4 py-1 border-neutral-300 dark:border-neutral-800 bg-violet-500/10 dark:bg-violet-800/5 rounded-md p-3">
                        {
                             ...
                             :
                             <span className="text-violet-600">LIIFG</span>
                        }
                        </div>
                    ...
                    <p className="text-sm text-neutral-400 dark:text-neutral-600 font-normal">
                        Valid till: <span className="text-sm font-medium">27 December</span>
                    </p>
                 ...
                 <div className="flex flex-1 flex-col space-y-5">
                    ...
                    <div className="flex items-center gap-x-5">
                        <div className="w-fit border border-dashed px-4 py-1 border-neutral-300 dark:border-neutral-800 bg-violet-500/10 dark:bg-violet-800/5 rounded-md p-3">
                        {
                             ...
                             <span className="text-green-600">Copied</span>
                             :
                             <span className="text-violet-600">DIMYL</span>
                        }
                        </div>
                        <button onClick={handleCopy2} className="text-xl text-violet-600">
                            <FaCopy/>
                        </button>
                    </div>
                    <p className="text-sm text-neutral-400 dark:text-neutral-600 font-normal">
