      ...
      <View style={styles.content}>
       ...
       <View style={styles.divider}>
        ...
        <TouchableOpacity style={styles.primaryButton} onPress={() => {
          ...
          <Text style={styles.primaryButtonText}>İstifadəçi kimi davam et</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.primaryButton} onPress={() => {
          ...
          <Text style={styles.primaryButtonText}>Bərbər kimi davam et</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.skipButton} onPress={() => {
          ...
          <Text style={styles.skipText}>
            Hesabınız yoxdur? <Text style={styles.skipLink}>Qeydiyyatdan keç</Text>
          </Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
